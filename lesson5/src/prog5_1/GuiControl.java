 ...
 *        creating various screen elements in a standardized way. Also, all
 *        screen element constants, like color names and screen sizes, are
 *        stored here.
 *        <p>
 *        <table border="1">
 *        <tr>
...
public class GuiControl {
	...
	public static Border createBlueTitledBorder(String title, Font f) {
		...
		Border lineborder = BorderFactory.createLineBorder(Color.blue.darker()
				.darker());
		return BorderFactory.createTitledBorder(lineborder, title,
				TitledBorder.DEFAULT_JUSTIFICATION,
				TitledBorder.DEFAULT_POSITION, f, Color.blue.darker().darker());
	}

	public static Border createRedTitledBorder(String title, Font f) {
		f = new Font(f.getName(), Font.BOLD, f.getSize());
		Border lineborder = BorderFactory.createLineBorder(Color.red.darker()
				.darker());
		return BorderFactory.createTitledBorder(lineborder, title,
				TitledBorder.DEFAULT_JUSTIFICATION,
				TitledBorder.DEFAULT_POSITION, f, Color.red.darker().darker());
	}
